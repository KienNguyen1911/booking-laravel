        ...
        <div class="container my-5">
            <div class="mb-5">
                <div class="owl-single dots-absolute owl-carousel">
                    <img src="client/images/slider-1.jpg" alt="Free HTML Template by Untree.co" class="img-fluid">
                    <img src="client/images/slider-2.jpg" alt="Free HTML Template by Untree.co" class="img-fluid">
                    <img src="client/images/slider-4.jpg" alt="Free HTML Template by Untree.co" class="img-fluid">
                </div>
            </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="row gutter-v2 gallery">
                            <div class="col-4">
                                <a href="images/gal_1.jpg" class="gal-item" data-fancybox="gal"><img
                                        src="client/images/gal_1.jpg" alt="Image" class="img-fluid"></a>
                            </div>
                            <div class="col-4">
                                <a href="images/gal_2.jpg" class="gal-item" data-fancybox="gal"><img
                                        src="client/images/gal_2.jpg" alt="Image" class="img-fluid"></a>
                            </div>
                            <div class="col-4">
                                <a href="images/gal_3.jpg" class="gal-item" data-fancybox="gal"><img
                                        src="client/images/gal_3.jpg" alt="Image" class="img-fluid"></a>
                            </div>
                            <div class="col-4">
                                <a href="images/gal_4.jpg" class="gal-item" data-fancybox="gal"><img
                                        src="client/images/gal_4.jpg" alt="Image" class="img-fluid"></a>
                            </div>
                            <div class="col-4">
                                <a href="images/gal_5.jpg" class="gal-item" data-fancybox="gal"><img
                                        src="client/images/gal_5.jpg" alt="Image" class="img-fluid"></a>
                            </div>
                            <div class="col-4">
                                <a href="images/gal_6.jpg" class="gal-item" data-fancybox="gal"><img
                                        src="client/images/gal_6.jpg" alt="Image" class="img-fluid"></a>
                            </div>
                        </div>
                    </div> <!-- END .custom-block -->
                    ...
                    <div class="custom-block" data-aos="fade-up">
                        ...
                        <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
                            ...
                            <img src="client/images/bg_1.jpg" alt="Image" class="img-fluid rounded">
                        </a>
                    </div> <!-- END .custom-block -->
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="custom-block" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="owl-single owl-carousel no-nav">
                            <div class="testimonial mx-auto">
                                ...
                                <blockquote>
                                    <p>&ldquo;There live the blind texts. Separated they live in Bookmarksgrove right at
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-3 mb-4">
                            <div class="team">
                                <img src="client/images/person_1.jpg" alt="Image" class="img-fluid mb-4">
                                <div class="px-3">
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="team">
                                <img src="client/images/person_2.jpg" alt="Image" class="img-fluid mb-4">
                                <div class="px-3">
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="team">
                                <img src="client/images/person_4.jpg" alt="Image" class="img-fluid mb-4">
                                <div class="px-3">
                        ...
                        <div class="col-lg-3 mb-4">
                            <div class="team">
                                <img src="client/images/person_3.jpg" alt="Image" class="img-fluid mb-4">
                                <div class="px-3">
