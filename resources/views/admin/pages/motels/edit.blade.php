            ...
            <div class="col-lg-8 col-sm-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Edit new motel </h6>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                        <form method="post" action="{{ route('motels.update', [$motel->id]) }}"
                            style="padding: 10px 20px 0px;" enctype="multipart/form-data" id="myForm">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-8 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <x-text-input type="text" class="form-control" name="address" id="address"
                                                :value="$motel->address" placeholder="ex: 123 Nguyen Van Linh" required />
